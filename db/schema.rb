...
ActiveRecord::Schema[7.2].define(version: 2026_09_16_130000) do
  ...
  create_table "families", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.boolean "bill_reminders_enabled", default: false, null: false
    t.integer "bill_reminder_days_before", default: 3, null: false
    t.check_constraint "bill_reminder_days_before >= 1 AND bill_reminder_days_before <= 30", name: "bill_reminder_days_before_range"
